-- | Build a gRPC server from a servant-reimagined API type.
--
...
-- @
module Servant.Reimagined.Grpc.Server
...
import Servant.Reimagined.Core.Method (KnownMethod, methodVal, Method(..))
...
import Servant.Reimagined.Grpc.Proto (GrpcCodec(..))
